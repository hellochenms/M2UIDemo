...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _showFullInfoView = [[M2ShowFullInfoView alloc] initWithFrame:CGRectMake(5, 5, CGRectGetWidth(frame) - 5 * 2, [M2ShowFullInfoView defaultHeight])];
        _showFullInfoView.backgroundColor = [UIColor grayColor];
        _showFullInfoView.maxNumberOfLinesWhenNotOpenning = 5;
